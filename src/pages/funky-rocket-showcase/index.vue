        ...
        <div class="grid md:grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ul class="space-y-1 text-gray-300">
              <li>• /public/assets/spine/walk/</li>
              <li>• /public/assets/spine/jump/</li>
              <li>• /public/assets/spine/rocket/</li>
              <li>• 簡化的命名方式</li>
            </ul>
          </div>
          <div>
...
import SimpleSpineViewer from '@/components/SimpleSpineViewer.vue'
...
const animations = computed<AnimationData[]>(() => {
  return animationConfigs.map(config => {
    const basePath = `/assets/spine/${config.spineFolder}`
    return {
      name: config.name,
